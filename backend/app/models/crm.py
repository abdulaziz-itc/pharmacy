from sqlalchemy import Column, Integer, String, ForeignKey, Date, Float, DateTime, Table, Boolean, Text
...
class BalanceTransactionType(str, enum.Enum):
    TOPUP = "topup"                # Qo'lda to'ldirish
    OVERPAYMENT = "overpayment"    # Fakturadan ortgan pul
    APPLICATION = "application"     # Faktura uchun ishlatilgan pul
