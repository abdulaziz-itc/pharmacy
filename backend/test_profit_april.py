    ...
    async with AsyncSessionLocal() as db:
        ...
        gross_profit_sum_q = select(
            func.coalesce(func.sum(
                ...
                ReservationItem.quantity * (func.coalesce(Invoice.paid_amount, 0) / func.cast(Invoice.total_amount, Float))
            ), 0.0)
        ...
        print("Gross Profit (2026):", gp.scalar())
