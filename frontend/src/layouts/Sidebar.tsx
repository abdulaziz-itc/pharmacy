...
const getSidebarItems = (role?: string, userId?: number) => {
    const allItems = [
        ...
        { icon: Activity, label: 'История входов', href: '/hrd/login-history', roles: ['admin', 'hrd'] },
        ...
        { icon: Package, label: 'Продукты', href: '/products', roles: ['admin', 'director', 'deputy_director', 'product_manager', 'med_rep', 'hrd'] },
        { icon: Map, label: 'Регионы', href: '/regions', roles: ['admin', 'director', 'deputy_director', 'product_manager', 'hrd'] },
        { icon: Building2, label: 'Организации', href: '/med-orgs', roles: ['admin', 'director', 'deputy_director', 'product_manager', 'field_force_manager', 'regional_manager', 'hrd'] },
