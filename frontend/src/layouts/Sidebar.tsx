...
const getSidebarItems = (role?: string, userId?: number) => {
    const allItems = [
        ...
        { icon: Users, label: 'Мед представители', href: '/med-reps', roles: ['admin', 'investor', 'director', 'deputy_director', 'product_manager', 'hrd'] },
        ...
        { icon: CalendarRange, label: 'Брони', href: '/reservations', roles: ['admin', 'investor', 'director', 'deputy_director', 'med_rep', 'product_manager'] },
        { icon: FileText, label: 'Фактура', href: '/invoices', roles: ['admin', 'investor', 'director', 'deputy_director', 'med_rep', 'product_manager'] },
        { icon: CreditCard, label: 'Дебиторка', href: '/debtors', roles: ['admin', 'investor', 'director', 'deputy_director', 'med_rep', 'product_manager'] },
