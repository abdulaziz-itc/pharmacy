...
import AdminSalaryApprovalPage from "./features/reports/AdminSalaryApprovalPage";
      ...
      <Router>
        <Routes>
          ...
          >
            ...
            <Route path="/salaries" element={<AdminSalaryApprovalPage />} />
            ...
            <Route path="/counterparty-balance" element={<BalanceManagement />} />
          </Route>
