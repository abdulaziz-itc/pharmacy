...
export function CreateWarehouseUserModal({ isOpen, onClose, onSuccess }: CreateWarehouseUserModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success("Завсклад успешно добавлен!");
        } catch (error: any) {
            console.error('Failed to create warehouse manager:', error);
